...
CameraOld::CameraOld() : _keyboard(_eye, _center, _up, _right) {
...
void CameraOld::update(double elapsedTime){
...
void CameraOld::key(int key, bool flag){
...
void CameraOld::mouse(MouseMode mode, float x, float y){
...
void CameraOld::screen(int width, int height){
...
void CameraOld::internalResolution(int height){
