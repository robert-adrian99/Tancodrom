...
void Skybox::init(){
	...
	// Load geometry.
	std::vector<float> cubeVertices{ -5.0, -5.0,  5.0,
		5.0, -5.0,  5.0,
		-5.0,  5.0,  5.0,
		5.0,  5.0,  5.0,
		-5.0, -5.0, -5.0,
...
void Skybox::draw(const glm::mat4& view, const glm::mat4& projection) const {
	...
	glm::mat4 model = glm::scale(glm::mat4(5.0f),glm::vec3(20.0f)); //findme: change these to increase skybox, therefore increase render distance
